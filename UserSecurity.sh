...
banner() {
  ...
  printf "                                                                         \e[0m\n"
  printf "\e[1;77m   ____ _ _               ____                       _ _          \e[0m\n"
  printf "\e[1;77m  / ___(_) |__   ___ _ __/ ___|  ___  ___ _   _ _ __(_) |_ _   _  \e[0m\n"
  printf "\e[1;77m | |   | | '_ \ / _ \ '__\___ \ / _ \/ __| | | | '__| | __| | | |\e[0m\n"
  printf "\e[1;77m | |___| | |_) |  __/ |   ___) |  __/ (__| |_| | |  | | |_| |_| |\e[0m\n"
  printf "\e[1;77m  \____|_|_.__/ \___|_|  |____/ \___|\___|\__,_|_|  |_|\__|\__, |\e[0m\n"
...
read -p $'\e[1;92m[\e[0m\e[1;77m?\e[0m\e[1;92m] Usuario para Escanear:\e[0m ' username

if [[ -e $username.txt ]]; then
printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Borrando archivo previo:\e[0m\e[1;77m %s.txt" $username
rm -rf $username.txt
fi
printf "\n"
printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Escaneando Usuario:\e[0m\e[1;77m %s\e[0m\e[1;92m Buscandolo \e[0m\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.instagram.com/%s\n" $username
printf "https://www.instagram.com/%s\n" $username > $username.txt
elif [[ $check_insta == *'0'* ]]; then
printf "\e[1;93mNo Encontrado - Posible fallo!\e[0m\n"
fi
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.facebook.com/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.twitter.com/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.youtube.com/%s\n" $username
...
if [[ $check == *'1'* ]]; then
printf "\e[1;92m Encontrado con exito en:\e[0m https://%s.blogspot.com\n" $username
...
if [[ $check == *'1'* ]]; then
printf "\e[1;92m Encontrado con exito en:\e[0m https://plus.google.com/+%s/posts\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.reddit.com/user/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://%s.wordpress.com\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.pinterest.com/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.github.com/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://%s.tumblr.com\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.flickr.com/photos/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://steamcommunity.com/id/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://vimeo.com/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://soundcloud.com/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://disqus.com/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://medium.com/@%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://%s.deviantart.com\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://vk.com/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://about.me/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://imgur.com/user/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://flipboard.com/@%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://slideshare.net/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://fotolog.com/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://open.spotify.com/user/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.mixcloud.com/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.scribd.com/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.badoo.com/en/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.patreon.com/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://bitbucket.org/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.dailymotion.com/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.etsy.com/shop/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://cash.me/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.behance.net/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.goodreads.com/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.instructables.com/member/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://keybase.io/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://kongregate.com/accounts/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://%s.livejournal.com\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://angel.co/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://last.fm/user/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://dribbble.com/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.codecademy.com/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://en.gravatar.com/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://pastebin.com/u/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://foursquare.com/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.gumroad.com/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://%s.newgrounds.com\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.wattpad.com/user/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.canva.com/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://creativemarket.com/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.trakt.tv/users/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://500px.com/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://buzzfeed.com/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://tripadvisor.com/members/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://%s.hubpages.com/\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://%s.contently.com\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://houzz.com/user/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://blip.fm/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.wikipedia.org/wiki/User:%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://news.ycombinator.com/user?id=%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.codementor.io/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.reverbnation.com/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.designspiration.net/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.bandcamp.com/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.colourlovers.com/love/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.ifttt.com/p/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.ebay.com/usr/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://%s.slack.com\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.okcupid.com/profile/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.trip.skyscanner.com/user/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://ello.co/%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://tracky.com/~%s\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://www.tripit.com/people/%s#/profile/basic-info\n" $username
...
printf "\e[1;92m Encontrado con exito en:\e[0m https://%s.basecamphq.com/login\n" $username
